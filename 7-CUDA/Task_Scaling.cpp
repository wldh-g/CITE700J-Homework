...
void task::scaling(bool enable_simd) {
  ...
  r = __exec<uint8_t, uint8_t>(c::scale_13, simd::scale_13, enable_simd, pirate_img, scale_13_c_img,
  ...
  r = __exec<uint8_t, uint8_t>(c::scale_24, simd::scale_24, enable_simd, pirate_img, scale_24_c_img,
