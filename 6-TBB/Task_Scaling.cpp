...
void task::scaling(bool enable_simd) {
  ...
  r = __exec<uint8_t, uint8_t>(c::scale_05, simd::scale_05, enable_simd, pirate_img,
                               scale_05_c_img, scale_05_simd_img, x_size, y_size);
  ...
  r = __exec<uint8_t, uint8_t>(c::scale_13, simd::scale_13, enable_simd, pirate_img,
                               scale_13_c_img, scale_13_simd_img, x_size, y_size);
  if ((r->error1 == nullptr) && (r->error2 == nullptr))
  ...
  r = __exec<uint8_t, uint8_t>(c::scale_24, simd::scale_24, enable_simd, pirate_img,
                               scale_24_c_img, scale_24_simd_img, x_size, y_size);
  if ((r->error1 == nullptr) && (r->error2 == nullptr))
